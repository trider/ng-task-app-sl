...
export class LoginComponent implements OnInit{
  ...
  path:string = '/login'
  pathAWD:string = 'https://u767k4g1u6.execute-api.us-east-1.amazonaws.com/api/users/login/user'
  ...
  onSubmit() {    
    ...
    this.httpService.postServiceData(this.path, this.loginForm.value).subscribe((response:any) => { 
