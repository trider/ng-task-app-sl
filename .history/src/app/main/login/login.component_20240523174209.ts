...
export class LoginComponent implements OnInit{
  ...
  onSubmit() {    
    ...
    this.httpService.postServiceData('https://u767k4g1u6.execute-api.us-east-1.amazonaws.com/api/users/login/user', this.loginForm.value).subscribe((response:any) => { 
